...
Applying best practices we shall follow to build restful API
---

## What I Was Building
<!-- The context. What was the goal? What problem were you solving? -->
Building restful API template using the  best practices of coding
## What I Did
<!-- Your approach. Key decisions made. No need for full detail — link to the code. -->
- I started to use typescript instead of JavaScript
- I also choose [[architecture/layer-based]] to build the template
## What I Learned
<!-- The honest takeaway. What shifted in your understanding? -->
How to organize application's components structure and how components interconnecting to each other in natural flow
## What Surprised Me
<!-- Optional but valuable. What didn't go as expected? -->
 It took me time renaming routes trying to do this in perfect way
---
...
- **Decision made:** [[decision/adopting-layer-based-architecture]]
- **Bug encountered:** 
